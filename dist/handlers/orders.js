...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ordersStore.index(req.query.id)];
            case 2:
                orders = _a.sent();
                orders.forEach(function (order) { return checkSatatus(order); });
                res.json(orders);
                return [3 /*break*/, 4];
            case 3:
                err_1 = _a.sent();
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ordersStore.show(req.query.id)];
            case 2:
                order = _a.sent();
                checkSatatus(order);
                res.json(order);
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ordersStore.create(req.body)];
            case 2:
                order = _a.sent();
                checkSatatus(order);
                res.json(order);
